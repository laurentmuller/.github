...
A centralized repository for reusable GitHub CI remote configuration files.

The code is copied from the [SymfonyCasts/.github](https://github.com/SymfonyCasts/.github) repository.
